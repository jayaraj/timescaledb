...
RUN set -ex \
    ...
    #&& apk add --no-cache --virtual .postgis-deps --repository  http://dl-cdn.alpinelinux.org/alpine/edge/testing  --repository http://dl-cdn.alpinelinux.org/alpine/edge/main \
        geos \
        gdal \
        proj \
        protobuf-c \
